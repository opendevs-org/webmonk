...
const accountsRoutes = require('./routes/accounts'); //NOTE: Importing the accounts route as a module
...
app.use('/api', accountsRoutes); //NOTE: registering every routes available in accountsRoutes as /api/[every-other-routes]
